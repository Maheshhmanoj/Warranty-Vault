...
import { FaTrash, FaCalendarAlt, FaPen, FaSortAmountDown, FaFilter, FaPlus } from 'react-icons/fa';
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {showAdd && (
          <div className="fixed inset-0 bg-black/80 z-50 flex justify-center items-center p-4 overflow-y-auto">
            <div className="bg-white border-4 border-black shadow-neo w-full max-w-2xl p-8 relative my-8">
              <AddItem 
                onSuccess={() => {
                  setShowAdd(false);
                  loadItems();
